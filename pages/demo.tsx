...
import bag from '../images/products/bag.jpg'
import lunchbag from '../images/lunchbag.jpg'
import thermos from '../images/products/thermos.jpg'
import together from '../images/products/together.jpg'
...
<div className="container px-5 py-20 mx-auto">
    <div className="lg:w-4/6 mx-auto flex flex-wrap">
        ...
        <div className="lg:w-1/3 lg:pt-28 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
