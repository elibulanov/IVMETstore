    ...
    return (
        <div className="p-6 container md:w-2/3 xl:w-auto mx-auto flex flex-col xl:items-stretch justify-between xl:flex-row">
            <div className="xl:w-1/2 md:mb-14 xl:mb-0 relative h-auto flex items-center justify-center">
                <img src="/mail.svg" alt="Envelope with a newsletter" role="img" className="" width={300}/>
            </div>
            <div className=" xl:w-1/2 xl:pl-20 xl:py-28 sm:1/2">
                ...
                <p className="text-base leading-normal text-gray-600 text-center xl:text-left">Sign up to our news feed to get discounts, and new product info.</p>
                <div className="flex items-stretch mt-12 lg:w-4/5">
